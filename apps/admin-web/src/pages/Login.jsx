...
const PORTAL = import.meta.env.VITE_PORTAL || "admin";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-sm bg-white shadow-md rounded-xl p-8">
        ...
        <p className="text-gray-500 mb-6 capitalize">{PORTAL} Portal Sign In</p>
        ...
        {step === "identifier" ? (
          <form onSubmit={requestOtp} className="space-y-4">
            <div>
              <label htmlFor="identifier" className="block text-sm font-medium mb-1">Email or Mobile Number</label>
              <input
                id="identifier"
                type="text"
                required
          ...
          <form onSubmit={verifyOtp} className="space-y-4">
            ...
            <input
              ...
              placeholder="Full name (first-time sign in only)"
            ...
            <button type="button" onClick={() => setStep("identifier")} className="w-full text-sm text-gray-500">
              Change email/mobile
            </button>
          </form>
        )}
