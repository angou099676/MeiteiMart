...
export default function LoginScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Fresh groceries & essentials, delivered fast.</Text>
      ...
      {step === "identifier" ? (
        ...
        <>
          ...
          <TextInput style={styles.input} placeholder="Your name (first time only)" value={name} onChangeText={setName} />
